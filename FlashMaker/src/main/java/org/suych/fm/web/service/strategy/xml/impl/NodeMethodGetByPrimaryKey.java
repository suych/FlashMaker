...
public class NodeMethodGetByPrimaryKey implements INode {
	...
	public XmlCommonNode assemble() {
		...
		include.setRefid(ConstantUnclassified.BASE_COLUMN_LIST);
		...
		textTwo.append(TAB + TAB + TAB + BaseInfo.getTableInfo().getPrimaryKey() + SPACE + EQUAL_SIGN + SPACE
				+ NUMBER_SIGN + LEFT_BRACE + ConstantParameterName.PRIMARY_KEY + COMMA + SPACE + ConstantSqlSyntax.JDBCTYPE
				+ EQUAL_SIGN + primaryKeyDataType + RIGHT_BRACE);
