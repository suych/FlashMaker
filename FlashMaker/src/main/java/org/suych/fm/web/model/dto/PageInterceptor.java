...
public class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (mappedStatement.getId().matches(pageSqlId)) {
			...
			if (parameterObject == null) {
				...
				PageParameterDTO page = (PageParameterDTO) metaStatementHandler
	 ...
	 * @return
	 */
	private String buildPageSql(String sql, PageParameterDTO page) {
		if (page != null) {
	 ...
	 * @return String
	 */
	private StringBuilder buildPageSqlForMysql(String sql, PageParameterDTO page) {
	 ...
	 * @return String
	 */
	private StringBuilder buildPageSqlForOracle(String sql, PageParameterDTO page) {
		StringBuilder pageSql = new StringBuilder(100);
		String beginrow = String.valueOf((page.getCurrentPage() - 1) * page.getPageSize());
